/* Blue Gums Carpentry — nav scroll state, mobile drawer, scroll-reveal, hero autoplay. */
(function () {
...
/* Hero video — force muted autoplay. Safari (macOS + iOS) ignores the `autoplay`
   attribute and shows a paused frame + play button. WebKit blocks play() *during* page
   load but allows it once the load event fires, so we kick it off then and retry a few
   times; a first-interaction fallback covers iOS Low Power Mode / "Auto-Play: Never". */
(function () {
